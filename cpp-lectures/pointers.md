Если мы просто передаём какой-то аргумент в функцию, то он скопируется. То же самое происходит, когда мы возвращаем что-то в return — значение просто скопируется наружу.
