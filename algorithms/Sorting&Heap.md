...
Пусть максимум не превосходит $k$, тогда создадим массив длины $k$. Для каждого элемента будем инкрементировать соответствующую позицию в массиве. Сложность $O(k + n)$, соответственно неплохо работает если $k < n\log{n}$.
